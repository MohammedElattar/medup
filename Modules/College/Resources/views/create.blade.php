...
@section('content')
    <x-ui.breadcrumbs :pages="['colleges' => route('colleges.index'), 'create']"/>
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal send-form" action="{{ route('colleges.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div>
                            <x-forms.multi-lang>

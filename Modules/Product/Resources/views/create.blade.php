...
@section('content')
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal send-form" action="{{ route('products.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="mb-1 col-12">
                            ...
                            <div>
                                <x-forms.select name="category_id" :options="$categories" :multiple="false"/>
                                @error('category_id')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        @if(UserTypeEnum::getUserType() != UserTypeEnum::INVENTORY_OWNER)
                            <div class="mb-1 col-12">
                                ...
                                <div>
                                    <x-forms.select name="inventory_owner_id" :options="$inventoryOwners" :multiple="false"/>

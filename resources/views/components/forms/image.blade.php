@php use App\Helpers\ResourceHelper;use Illuminate\Support\Str; @endphp
@props([
    'name' => 'image',
    'relation' => '',
    'id' => '',
...
<div>
    ...
    <img
        ...
        id="{{$id}}-preview"
        src="{{$item ? ResourceHelper::getFirstMediaOriginalUrl($item, $relation): asset('storage/default/store.png')}}"
    />
